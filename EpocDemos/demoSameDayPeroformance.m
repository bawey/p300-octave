...
[b1_model b1_modelCell b1_featsSelectCell b1_summary] = pickClassifier(b1_p3_tr, 'fast', 'min');
...
[b2_model b2_modelCell b2_featsSelectCell b2_summary] = pickClassifier(b2_p3_tr, 'fast', 'min');
...
[b3_model b3_modelCell b3_featsSelectCell b3_summary] = pickClassifier(b3_p3_tr, 'fast', 'min');
...
[b4_model b4_modelCell b4_featsSelectCell b4_summary] = pickClassifier(b4_p3_tr, 'fast', 'min');
b4_scores = trainTestMesh(b4_p3_tr, b4_p3_te, b4_modelCell);

%save all the variables into a binary file
save('-binary', sprintf('%s/demoSameDayPerformance_2.0.oct', eeg_dir));